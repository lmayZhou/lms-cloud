...
api 'com.lmaye:lms-cloud-starter-serial-no:1.2.10'
compile 'com.lmaye:lms-cloud-starter-serial-no:1.2.10'
// implementation 引用的包对于其他module是不可见的
implementation 'com.lmaye:lms-cloud-starter-serial-no:1.2.10'
```
